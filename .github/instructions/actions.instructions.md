...
3. Add `my-action/action.yml` (own subdirectory, following the `build/`, `install/`, `deploy/`, `build-resume/`, `provision-pool/` convention) with `main: '../dist/my-action-main.js'`
