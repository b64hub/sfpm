...
export class InstallerRegistry {
    private static installers = new Map<Omit<PackageType, 'managed' | 'data' | 'diff'>, InstallerConstructor>();

    /**
     * Registers an installer for a specific package type
     */
    public static register(type: Omit<PackageType, 'managed' | 'data' | 'diff'>, installer: InstallerConstructor) {
     ...
     */
    public static getInstaller(type: Omit<PackageType, 'managed' | 'data' | 'diff'>): InstallerConstructor | undefined {
 ...
 */
export function RegisterInstaller(type: Omit<PackageType, 'managed' | 'data' | 'diff'>) {
